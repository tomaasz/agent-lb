// Reflect the active account in the terminal title (e.g. "agentlb 2/4 work"),
// so a backgrounded or tabbed `agentlb server` is glanceable without
...
// Short, glanceable title: "agentlb <pos>/<total> <name>". `index` is 0-based.
